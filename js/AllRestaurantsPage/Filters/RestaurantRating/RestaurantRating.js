...
class RestaurantRating extends Component {
	...
	ratingHandle = e => {
		...
		for (let i = 0; i <= stars - 1; i++) {
			allStars[allStars.length - 1 - i].className =
				'stars__item stars__item__active';
		}
	};
		...
		return (
			<div className="deliveryRating">
				...
				<ul className="list-inline stars" onClick={e => this.ratingHandle(e)}>
					<li className="stars__item" data-id="5">
						<span className="fa fa-star"></span>
					</li>
					<li className="stars__item" data-id="4">
						<span className="fa fa-star"></span>
					</li>
					<li className="stars__item" data-id="3">
						<span className="fa fa-star"></span>
					</li>
					<li className="stars__item" data-id="2">
						<span className="fa fa-star"></span>
					</li>
					<li className="stars__item" data-id="1">
						<span className="fa fa-star"></span>
					</li>
				</ul>
			</div>
